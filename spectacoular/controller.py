...
#         # self.get_widgets = lambda self: {'selectChannel' : self.selectChannel,
#         #                              'colorSelector' : self.colorSelector}
        
#     def get_widgets(self):
#         return {'selectChannel' : self.selectChannel,'colorSelector' : self.colorSelector}
...
#         self.colorSelector.children[0] = Select(title=titel, 
#                             value=self.lineColors[0], options=self.lineColors)
