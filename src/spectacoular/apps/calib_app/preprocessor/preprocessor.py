...
import numpy as np
from traits.api import Float, Instance, Int, observe
...
class CalibPreprocessor(ac.TimeOut):
    ...
    3. Average: Averages over num_per_average samples
    ...
    ----------
        ...
        num_per_average: Number of samples per average.
    """
    ...
    def __init__(self, band=1000.0, num_per_average=512, **kwargs):
        ...
        self.band = band
        self.num_per_average = num_per_average

    @observe('source')
    def _update_pipeline(self, _):
        ...
        self._avg = ac.Average(source=self._square, num_per_average=self.num_per_average)
