...
import numpy as np
from traits.api import Instance, Float, Int
...
class Calib(ac.TimeOut):
    ...
    Attributes:
        ...
        referenceMagnitude: Known reference level of the calibration device.
        ...
        _stable_count: Internal counter for stable blocks.
    """
    ...
    referenceMagnitude = Float(0.0, desc="reference magnitude of calibration device (Pa, m/s², N or V depending on sensor)")
    ...
    def is_complete(self) -> bool:
        ...
        """
        return self._stable_count >= self.required_stable
...
class StdCalib(Calib):
    ...
    Computes the calibration factor as:
        S_hat = referenceMagnitude / mean(buffer)
    ...
    def result(self, num):
        ...
        referenceMagnitude / mean. When complete, saves final calibfactor.
        ...
        for block in self.source.result(num):
            ...
            if mean_val > 0:   
                self.current_estimate = self.referenceMagnitude / mean_val
