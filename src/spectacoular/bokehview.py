...
def add_bokeh_attr(cls, trait_widget_mapper, trait_widget_args):
    ...
    trait_widget_mapper : dict
        Dictionary containing the names of the trait attributes and the
        corresponding Bokeh widgets.
    trait_widget_args : dict
        Additional widget arguments that should be included when a widget is
        created.
    ...
    """
    cls.trait_widget_mapper = trait_widget_mapper
    cls.trait_widget_args = trait_widget_args
    cls.get_widgets = get_widgets
    cls.set_widgets = set_widgets
...
trait_widget_args = {
    'gamma': {'disabled': False, 'mode': 'float'},
    'precision': {'disabled': False},
    'cached': {'disabled': False},
}
...
eva_columns = [
    TableColumn(field='eva_list', title='eigenvalues', editor=NumberEditor()),
]
...
trait_widget_args = {
    'eva_list': {'disabled': False, 'editable': True, 'columns': eva_columns},
    'n': {'disabled': False, 'mode': 'int'},
    'r_diag_norm': {'disabled': False, 'mode': 'float'},
    'precision': {'disabled': False},
    'cached': {'disabled': False},
...
trait_widget_args = {
    'x_min': {'disabled': False, 'mode': 'float'},
...
loc_columns = [
    TableColumn(field='loc', title='source location', editor=NumberEditor()),
]
...
trait_widget_mapper = {
    'num_per_average': NumericInput,
    'num_samples': NumericInput,
    'sample_freq': NumericInput,
}
trait_widget_args = {
    'num_per_average': {'disabled': False, 'mode': 'int'},
    'num_samples': {'disabled': True, 'mode': 'int'},
    'sample_freq': {'disabled': True, 'mode': 'float'},
}
...
trait_widget_args = {
    'threshold': {'disabled': False, 'mode': 'float'},
...
trait_widget_args = {
    'trigger_per_revo': {'disabled': False, 'mode': 'int'},
...
trait_widget_mapper = {'file': TextInput, 'precision': Select}
trait_widget_args = {
    'file': {'disabled': False},
    'precision': {'disabled': False},
}
